...
if(file.exists(paste(r.dir, "Paper/qusage_results.Rdata", sep = ""))){
  load(paste(r.dir, "Paper/qusage_results.Rdata", sep = ""))
}
...
pdf(paste(results.dir, "RMT_SBP_Modular_analysis_d3-6_facet_August.pdf", sep = ""), height = 13, width = 12)
plot(x)
dev.off()
```
...
```{r save}
if(!file.exists(paste(r.dir, "Paper/qusage_results.Rdata", sep = ""))){
save(results.svn, results.rvn, file = paste(r.dir, "Paper/qusage_results.Rdata", sep = ""))
}
```
